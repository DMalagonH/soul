...
<?php if ( have_comments() ) : ?>
	<h2 class="comments"><?php comments_number('No Comments', '1 Comment', '% Comments' );?> to &#8220;<?php the_title(); ?>&#8221;</h2>
...
<div id="respond">
<h2 class="comments"><?php comment_form_title( 'Post comment', 'Post comment on %s' ); ?></h2>
