...
jQuery.noConflict();
	jQuery(document).ready(function(){
		...
		jQuery('.flexslider').flexslider({ 
			animation:'<?php if(of_get_option('webfolio_slidereffect')==''): echo 'slide';
				  else: echo of_get_option('webfolio_slidereffect');
				  endif;?>',
			controlNav:true,
			animationLoop: true,  
			controlsContainer:"",
			...
			prevText:"&lsaquo;",
			keyboardNav: true,  
			slideshowSpeed: <?php if(of_get_option('webfolio_sliderpausetime')==''): echo '3000';
				  else: echo of_get_option('webfolio_sliderpausetime');
				  endif;?>,
			animationSpeed: <?php if(of_get_option('webfolio_slideranimationspeed')==''): echo '500';
